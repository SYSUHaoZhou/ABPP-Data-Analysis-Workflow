...
# Read the data
data <- read.csv("~/liver-dy.csv", stringsAsFactors = FALSE)
...
write.csv(modifications_extract, "~/liver-dy-modifications.csv", row.names = FALSE)
...
write.csv(positions_extract, "~/liver-dy-positions.csv", row.names = FALSE)
print("Positions extract result saved to 'ldc5.15-liver-dy-positions.csv'.")

############################################# Step 3: Merge Files ###################################################################

# Read the two extracted CSV files
positions <- read.csv("~/liver-dy-positions.csv", stringsAsFactors = FALSE)
modifications <- read.csv("~/liver-dy-modifications.csv", stringsAsFactors = FALSE)
...
write.csv(merged_data, "~/liver-dy-merged.csv", row.names = FALSE)
print("Merged data saved to 'ldc5.15-liver-dy-merged.csv'.")

############################################# Step 4: Expand Rows and Remove Duplicates ############################################

# Read the merged CSV file
merged_file <- read.csv("~/liver-dy-merged.csv", stringsAsFactors = FALSE)
...
output_file <- "~/liver-dy-merged-expanded.csv"
